...
def generate_launch_description():
    ...
    pkg_two_wheel_robot = get_package_share_directory('two_wheel_robot')

    gazebo_models_path, ignore_last_dir = os.path.split(pkg_two_wheel_robot)
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([pkg_two_wheel_robot, 'rviz', LaunchConfiguration('rviz_config')])],
