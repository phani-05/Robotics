...
def generate_launch_description():
    ...
    default_rviz_config_path = PathJoinSubstitution([pkg_two_wheel_robot, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the two_wheel_robot package
